...
export default function CirculationScreen() {
  ...
  const regles = [
    { titre: "Priorité aux piétons", texte: "Les chariots doivent toujours céder le passage aux piétons." },
    { titre: "Zones piétonnes", texte: "Rester dans les couloirs verts ou marqués au sol." },
    { titre: "Angles morts", texte: "Ne jamais traverser derrière un chariot ou une machine." },
    { titre: "Vitesse limitée", texte: "Les engins doivent rouler à vitesse réduite en intérieur." },
    { titre: "Arrêt aux intersections", texte: "Toujours marquer un arrêt avant de traverser un croisement." },
    { titre: "Téléphone interdit en zone de circulation", texte: "Sauf pour consulter les règles de sécurité." }
  ];

  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Règles de circulation interne</Text>
      ...
      <Text style={styles.encouragement}>
        Une seconde d’inattention peut coûter une vie.  
        Respecter les règles de circulation, c’est protéger tout le monde.
      </Text>
