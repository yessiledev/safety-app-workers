...
export default function DashboardScreen() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("FicheMetier", { metier: posteDuJour })}>
        <Text style={styles.buttonText}>Voir la fiche métier</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("SignalerDanger")}>
        <Text style={styles.buttonText}>Signaler un danger</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("HistoriqueDangers")}>
        <Text style={styles.buttonText}>Historique des signalements</Text>
      </TouchableOpacity>

      {/* Tous les autres boutons */}
      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("Procedures")}>
        <Text style={styles.buttonText}>Procédures essentielles</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("Formation")}>
        <Text style={styles.buttonText}>Formation sécurité</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("ConsignesSite")}>
        <Text style={styles.buttonText}>Consignes du site</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("AssistantIA")}>
        <Text style={styles.buttonText}>Assistant IA</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("EPI")}>
        <Text style={styles.buttonText}>EPI obligatoires</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("Accident")}>
        <Text style={styles.buttonText}>Accident du travail : que faire ?</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("SituationsDangereuses")}>
        <Text style={styles.buttonText}>Reconnaître les dangers</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("Circulation")}>
        <Text style={styles.buttonText}>Règles de circulation</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("RisquesChimiques")}>
        <Text style={styles.buttonText}>Risques chimiques</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("RisqueIncendie")}>
        <Text style={styles.buttonText}>Risque incendie</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("PremiersSecours")}>
        <Text style={styles.buttonText}>Gestes qui sauvent</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("Manutention")}>
        <Text style={styles.buttonText}>Manutention</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("TravailHauteur")}>
        <Text style={styles.buttonText}>Travail en hauteur</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("AmbiancesSonores")}>
        <Text style={styles.buttonText}>Ambiances sonores</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("AmbiancesThermiques")}>
        <Text style={styles.buttonText}>Ambiances thermiques</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("ProduitsDangereux")}>
        <Text style={styles.buttonText}>Produits dangereux</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("EquipementsTravail")}>
        <Text style={styles.buttonText}>Équipements de travail</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("ZonesInterdites")}>
        <Text style={styles.buttonText}>Zones interdites</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("ConduiteEngins")}>
        <Text style={styles.buttonText}>Conduite d'engins</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("TravailIsole")}>
        <Text style={styles.buttonText}>Travail isolé</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("ModeJeuneRecrueIntro")}>
